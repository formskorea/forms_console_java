...
data class Work(
    ...
    @SerializedName("cname") var strClientName: String? = null,
    @SerializedName("cmobile") var strClientMobile: String? = null,
    @SerializedName("cemail") var strClientEmail: String? = null,
